/**
 * UTC Date utilities for backend operations
 * All dates are handled in UTC on the backend and converted to local time on frontend
 * Uses Luxon for robust date/time handling with timezone support
 */
